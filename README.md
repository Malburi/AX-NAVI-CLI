...
> **alpha (v0.1.0-alpha.2).** 실제 저장소에서 매일 쓰면서 다듬는 중입니다.
...
```bash
npm i -g https://codeload.github.com/Malburi/AX-NAVI-CLI/tar.gz/refs/tags/v0.1.0-alpha.2
```
...
```bash
npm pack                                  # axnavi-0.1.0-alpha.2.tgz 생성
npm i -g \\공유폴더\axnavi-0.1.0-alpha.2.tgz   # 받는 쪽
```
